...
def bulk_indexing():
    ...
    logs = models.Log.objects.filter(datetime__date__gte = timezone.now() - timedelta(hours = 7*24+3), datetime__date__lt = timezone.now() - timedelta(hours = 3)).all()
...
def count_logs(resources, userid = 0):
    ...
    if userid != 0:
        s = s.query('bool', must=[Q("range", datetime={'time_zone': '-03:00', 'gte': 'now-7d', 'lte': 'now'}), Q("match", component="resources"), Q('bool', should=[Q('match', action='access'), Q('match', action='view')]), Q('bool', should=conds), Q('match', user_id=userid)])
    else:
        s = s.query('bool', must=[Q("range", datetime={'time_zone': '-03:00', 'gte': 'now-7d', 'lte': 'now'}), Q("match", component="resources"), Q('bool', should=[Q('match', action='access'), Q('match', action='view')]), Q('bool', should=conds)])
...
def resource_accessess(resource, userid = 0):
    ...
    if userid != 0:
        s = s.query('bool', must=[Q("range", datetime={'time_zone': '-03:00', 'gte': 'now-7d', 'lte': 'now'}), Q("match", component="resources"), Q('bool', should=[Q('match', action='access'), Q('match', action='view')]), Q('match', **{'context__' + resource._my_subclass + '_id': resource.id}), Q('match', user_id=userid)])
    else:
        s = s.query('bool', must=[Q("range", datetime={'time_zone': '-03:00', 'gte': 'now-7d', 'lte': 'now'}), Q("match", component="resources"), Q('bool', should=[Q('match', action='access'), Q('match', action='view')]), Q('match', **{'context__' + resource._my_subclass + '_id': resource.id})])
...
def count_access_subject(subject, userid):
    ...
    s = s.query('bool', must=[Q("range", datetime={'time_zone': '-03:00', 'gte': 'now-7d', 'lte': 'now'}), Q("match", component="subject"), \
...
def count_diff_days(subject, userid):
    ...
    s = s.query('bool', must=[Q("range", datetime={'time_zone': '-03:00', 'gte': 'now-7d', 'lte': 'now'}), Q('match', resource='subject'), Q('match', **{'context__subject_id': subject}), Q('match', user_id=userid), Q('bool', should=[Q('match', action='access'), Q('match', action='view')])])
...
def count_access_resources(subject, userid):
    ...
    s = s.query('bool', must=[Q("range", datetime={'time_zone': '-03:00', 'gte': 'now-7d', 'lte': 'now'}), Q("match", component="resources"), Q('match', **{'context__subject_id': subject}), Q('match', user_id=userid)])
