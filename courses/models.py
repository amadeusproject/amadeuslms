...
class Course(models.Model):
	...
	slug = AutoSlugField(_("Slug"),populate_from='name',unique=True)
	create_date = models.DateTimeField(_('Creation Date'), auto_now_add = True, blank = True)
	category = models.ForeignKey(CourseCategory, verbose_name = _('Category'), related_name='course_category')
	coordenator = models.ForeignKey(User, verbose_name = _('Coordenator'), related_name ='course_coordenator', null = True, blank = True)
