...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    social_name = models.CharField(
        _("Social Name"), max_length=100, blank=True, null=True
    )
    ...
    show_email = models.IntegerField(
        ...
        blank=True,
        choices=(
            (1, _("Allow everyone to see my address")),
            (2, _("Only classmates can see my address")),
            (3, _("Nobody can see my address")),
        ),
        default=1,
    )
    is_support = models.BooleanField(_("Support"), default=False)
