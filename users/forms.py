...
class RegisterUserForm(Validation):
    ...
    class Meta:
        model = User
        fields = ['email', 'username', 'last_name', 'social_name', 'image', 'show_email', 'x', 'y',
                  'width', 'height', ]
        widgets = {
...
class ProfileForm(Validation):
    ...
    class Meta:
        model = User
        fields = ['email', 'username', 'last_name', 'social_name', 'description', 'show_email',
                  'image']
        widgets = {
    ...
    def clean_password(self):
        ...
        if not self.user.check_password(password):
            self._errors['password'] = [
                _('The value inputed does not match with your actual password.')]
