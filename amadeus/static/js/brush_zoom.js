...
class GanttChart {
    ...
    filter(status, element) {
        ...
        if (a.filtered.indexOf(true) == -1 || a.filtered.indexOf(false) == -1)
            ...
            a.legend.legend.attr("opacity", function(d,i){
                ...
                if(a.filtered[i]==true)
                    return "cursor:url('cursors/subber.cur'),auto";
                else   
                    return "cursor:url('cursors/adder.cur'),auto";
            });
        }
    ...
    filterout(status, element) {
        ...
        if (status != undefined) {
            ...
            a.legend.legend.attr("opacity", 1).attr("style","cursor:url('cursors/filter.cur'),auto");
