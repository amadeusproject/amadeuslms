...
urlpatterns = [
    ...
    url(r'^links/', include(('links.urls', "links"), namespace='links')),
    url(r'^pdf_files/', include(('pdf_file.urls', "pdf_files"), namespace='pdf_files')),
    url(r'^questionary/', include(('questionary.urls', "questionary"), namespace='questionary')),
    url(r'^webconferences/', include(('webconference.urls', "webconference"), namespace='webconferences')),
    ...
    url(r'^dashboards/', include(('dashboards.urls', "dashboards"), namespace='dashboards')),
    url(r'^bulletin/', include(('bulletin.urls', "bulletin"), namespace='bulletin')),
    url(r'^questions_database/', include(('banco_questoes.urls', "banco_questoes"), namespace='questions_database')),
