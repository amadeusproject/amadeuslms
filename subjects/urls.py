...
urlpatterns = [
    ...
    url(r'^replicate/(?P<subject_slug>[\w_-]+)/$', views.SubjectCreateView.as_view(),
        name='replicate'),
    ...
    url(r'^view/(?P<slug>[\w_-]+)/(?P<topic_slug>[\w_-]+)/$', views.SubjectDetailView.as_view(),
        name='topic_view'),
    ...
    url(r'^report/', include(('reports.urls', 'reports'), namespace='reports')),
