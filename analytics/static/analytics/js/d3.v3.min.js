...
!function(){
    ...
    function l(){
        var n=0;for(var t in this)t.charCodeAt(0)===oa&&++n;return n
    }
    function f(){
        for(var n in this)
    ...
    function p(n,t){
        ...
        for(var e=0,r=aa.length;r>e;++e){
            var u=aa[e]+t;if(u in n)return u
        }
    }
    function v(){}
    function d(){}
    ...
    function M(n){
        ...
        return t.of=function(e,r){
            return function(u){
                try{
                    var i=u.sourceEvent=Zo.event;u.target=n,Zo.event=u,t[u.type].apply(e,r)
                }finally{
                    Zo.event=i
                }
            }
    ...
    function F(n,t,e){
        ...
        var o="__on"+n,a=n.indexOf("."),c=O;a>0&&(n=n.substring(0,a));
        var s=ya.get(n);
