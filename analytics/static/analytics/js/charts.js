      ...
      var chartConfig = {
        ...
        interactions: {
          click: function(element, data) {
            console.log(data), alert(d3.textData(data, "<name>: <value> acesso(s)"));
          },
        },
        tooltip: {
    ...
    $.get(url, function(dataset) {
      ...
      rects.on("mouseover", function(d, i) {
        ...
        tooltipDiv
          ...
          .style("opacity", 0.9);
        tooltipDiv
          .html("<p style='font-size:9px'>" + d.name + "( " + d.count + " )" + "</p>")
          .style("left", i * (width / dataset.length) + barPadding + marginLeft + "px")
          .style("top", height - yScale(d.count) - bottomPadding + "px");
      });
  ...
  most_used_tags: function(url) {
    $.get(url, function(dataset) {
      ...
      var dataconfig = {
        ...
        interactions: {
          click: function(element, data) {
            console.log(data), alert(d3.textData(data, "<text>: <value> acesso(s)"));
          },
        },
        tooltip: {
          text: "<text>: <value> acesso(s)",
